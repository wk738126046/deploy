...
def parse_args():
    ...
    parser.add_argument('--pretrained', dest='pretrained', help='pretrained model prefix',
                        default=None)#os.path.join(os.getcwd(), 'model', 'vgg16_reduced'), type=str)    
    ...
    # vgg16 lr=0.002 m=0.9, wd=0.0005
    # mobilenet v2 lr 
    ...
    parser.add_argument('--num-example', dest='num_example', type=int, default=5011,
                        help='number of image examples') # 16551 (07+12)
